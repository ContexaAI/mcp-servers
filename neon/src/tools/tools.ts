...
export const NEON_HANDLERS: Record<string, (args: any, neonClient: any, extra?: any) => Promise<any>> = {
  list_projects: async ({ params }: any, neonClient: any, extra: any) => {
  ...
  create_project: async ({ params }: any, neonClient: any, extra: any) => {
    try {
      const organization = await getOrgByOrgIdOrDefault(
        params,
        neonClient,
  ...
  delete_project: async ({ params }: any, neonClient: any) => {
  ...
  describe_project: async ({ params }: any, neonClient: any) => {
  ...
  run_sql: async ({ params }: any, neonClient: any, extra: any) => {
    const result = await handleRunSql(
      {
        sql: params.sql,
        databaseName: params.databaseName,
  ...
  run_sql_transaction: async ({ params }: any, neonClient: any, extra: any) => {
    const result = await handleRunSqlTransaction(
      {
  ...
  describe_table_schema: async ({ params }: any, neonClient: any, extra: any) => {
  ...
  get_database_tables: async ({ params }: any, neonClient: any, extra: any) => {
  ...
  create_branch: async ({ params }: any, neonClient: any) => {
  ...
  prepare_database_migration: async ({ params }: any, neonClient: any, extra: any) => {
  ...
  complete_database_migration: async ({ params }: any, neonClient: any, extra: any) => {
