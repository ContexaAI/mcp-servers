...
const PORT = 8080;
const MCP_SERVER_NAME = 'supabase/postgrest';
/**
 ...
 */
export async function contexaStart(server: Server | McpServer) {
  const app = express();
  ...
  app.get(['/health', '/'], (_req, res) => {
    res.json({ status: 'OK', server: SERVER_NAME, version: SERVER_VERSION, serverName: MCP_SERVER_NAME });
  });
