...
export function registerTools(server: McpServer) {
  ...
  /*
    ...
    async ({ }) => {
        ...
        if (!clientId) {
            console.warn("MICROSOFT_TEAMS_CLIENT_ID environment variable not set, skipping Microsoft Teams teams listing.");
            return {
              content: [{
                type: "text",
                text: "Microsoft Teams client ID not configured. Please set MICROSOFT_TEAMS_CLIENT_ID environment variable."
              }],
              isError: true
            };
        }
        ...
        if (!clientSecret) {
            console.warn("MICROSOFT_TEAMS_CLIENT_SECRET environment variable not set, skipping Microsoft Teams teams listing.");
            return {
              content: [{
                type: "text",
                text: "Microsoft Teams client secret not configured. Please set MICROSOFT_TEAMS_CLIENT_SECRET environment variable."
              }],
              isError: true
            };
        }
        ...
        if (!refreshToken) {
            console.warn("MICROSOFT_TEAMS_REFRESH_TOKEN environment variable not set, skipping Microsoft Teams teams listing.");
            return {
              content: [{
                type: "text",
                text: "Microsoft Teams refresh token not configured. Please set MICROSOFT_TEAMS_REFRESH_TOKEN environment variable."
              }],
              isError: true
            };
        }
    ...
    async ({ teamId }) => {
        ...
        const clientId = process.env.MICROSOFT_TEAMS_CLIENT_ID;
        if (!clientId) {
            console.warn("MICROSOFT_TEAMS_CLIENT_ID environment variable not set, skipping Microsoft Teams channels listing.");
            return {
              content: [{
                type: "text",
                text: "Microsoft Teams client ID not configured. Please set MICROSOFT_TEAMS_CLIENT_ID environment variable."
        ...
        const clientSecret = process.env.MICROSOFT_TEAMS_CLIENT_SECRET;
        if (!clientSecret) {
            console.warn("MICROSOFT_TEAMS_CLIENT_SECRET environment variable not set, skipping Microsoft Teams channels listing.");
            return {
              content: [{
                type: "text",
                text: "Microsoft Teams client secret not configured. Please set MICROSOFT_TEAMS_CLIENT_SECRET environment variable."
        ...
        const refreshToken = process.env.MICROSOFT_TEAMS_REFRESH_TOKEN;
        if (!refreshToken) {
            console.warn("MICROSOFT_TEAMS_REFRESH_TOKEN environment variable not set, skipping Microsoft Teams channels listing.");
            return {
              content: [{
                type: "text",
                text: "Microsoft Teams refresh token not configured. Please set MICROSOFT_TEAMS_REFRESH_TOKEN environment variable."
  ...
  server.tool(
    ...
    async ({}) => {
      ...
      try {
        ...
        if (!token) {
          console.warn("NOTION_API_KEY environment variable not set, skipping Notion databases listing.");
          return {
            content: [{
              type: "text",
              text: "Notion API key not configured. Please set NOTION_API_KEY environment variable."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({}) => {
      ...
      try {
        ...
        if (!apiKey) {
          console.warn("LINEAR_API_KEY environment variable not set, skipping Linear projects listing.");
          return {
            content: [{
              type: "text",
              text: "Linear API key not configured. Please set LINEAR_API_KEY environment variable."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({}) => {
      ...
      try {
        ...
        if (!botToken) {
          console.warn("SLACK_BOT_TOKEN environment variable not set, skipping Slack channels listing.");
          return {
            content: [{
              type: "text",
              text: "Slack bot token not configured. Please set SLACK_BOT_TOKEN environment variable."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({}) => {
      ...
      try {
        ...
        if (!clientId) {
          console.warn("SHAREPOINT_CLIENT_ID environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "SharePoint client ID not configured. Please set SHAREPOINT_CLIENT_ID environment variable."
            }],
            isError: true
          };
        }
        ...
        if (!clientSecret) {
          console.warn("SHAREPOINT_CLIENT_SECRET environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "SharePoint client secret not configured. Please set SHAREPOINT_CLIENT_SECRET environment variable."
            }],
            isError: true
          };
        }
        ...
        if (!refreshToken) {
          console.warn("SHAREPOINT_REFRESH_TOKEN environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "SharePoint refresh token not configured. Please set SHAREPOINT_REFRESH_TOKEN environment variable."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ libraryId }) => {
      ...
      try {
        const clientId = process.env.SHAREPOINT_CLIENT_ID;
        if (!clientId) {
          console.warn("Please set SHAREPOINT_CLIENT_ID environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set SHAREPOINT_CLIENT_ID environment variable. environment variable not configured. Please set Please set SHAREPOINT_CLIENT_ID environment variable.."
            }],
            isError: true
          };
        }
        ...
        const clientSecret = process.env.SHAREPOINT_CLIENT_SECRET;
        if (!clientSecret) {
          console.warn("Please set SHAREPOINT_CLIENT_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set SHAREPOINT_CLIENT_SECRET environment variable. environment variable not configured. Please set Please set SHAREPOINT_CLIENT_SECRET environment variable.."
            }],
            isError: true
          };
        }
        ...
        const refreshToken = process.env.SHAREPOINT_REFRESH_TOKEN;
        if (!refreshToken) {
          console.warn("Please set SHAREPOINT_REFRESH_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set SHAREPOINT_REFRESH_TOKEN environment variable. environment variable not configured. Please set Please set SHAREPOINT_REFRESH_TOKEN environment variable.."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ libraryId, folderId, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!accountName) {
          console.warn("Please set SHAREPOINT_ACCOUNT_NAME environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set SHAREPOINT_ACCOUNT_NAME environment variable. environment variable not configured. Please set Please set SHAREPOINT_ACCOUNT_NAME environment variable.."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ folderId, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!clientId) {
          console.warn("ONEDRIVE_CLIENT_ID environment variable not set, skipping operation."); return { content: [{ type: "text", text: "OneDrive client ID not configured. Please set ONEDRIVE_CLIENT_ID environment variable." }], isError: true };
        }

        const clientSecret = process.env.ONEDRIVE_CLIENT_SECRET;
        if (!clientSecret) {
          console.warn("Please set ONEDRIVE_CLIENT_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set ONEDRIVE_CLIENT_SECRET environment variable. environment variable not configured. Please set Please set ONEDRIVE_CLIENT_SECRET environment variable.."
            }],
            isError: true
          };
        }
        ...
        if (!refreshToken) {
          console.warn("Please set ONEDRIVE_REFRESH_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set ONEDRIVE_REFRESH_TOKEN environment variable. environment variable not configured. Please set Please set ONEDRIVE_REFRESH_TOKEN environment variable.."
            }],
            isError: true
          };
        }
    ...
    async ({ folderId, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!serviceAccountJson) {
          ...
          if (!clientId) {
            console.warn("Please set GOOGLE_DRIVE_CLIENT_ID environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set GOOGLE_DRIVE_CLIENT_ID environment variable. environment variable not configured. Please set Please set GOOGLE_DRIVE_CLIENT_ID environment variable.."
            }],
            isError: true
          };
          }
          ...
          if (!clientSecret) {
            console.warn("Please set GOOGLE_DRIVE_CLIENT_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set GOOGLE_DRIVE_CLIENT_SECRET environment variable. environment variable not configured. Please set Please set GOOGLE_DRIVE_CLIENT_SECRET environment variable.."
            }],
            isError: true
          };
          }
          ...
          if (!refreshToken) {
            console.warn("Please set GOOGLE_DRIVE_REFRESH_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set GOOGLE_DRIVE_REFRESH_TOKEN environment variable. environment variable not configured. Please set Please set GOOGLE_DRIVE_REFRESH_TOKEN environment variable.."
            }],
            isError: true
          };
          }
  ...
  server.tool(
    ...
    async ({ path, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!appKey) {
          console.warn("DROPBOX_APP_KEY environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Dropbox app key not configured. Please set DROPBOX_APP_KEY environment variable." }], isError: true };
        }

        const appSecret = process.env.DROPBOX_APP_SECRET;
        if (!appSecret) {
          console.warn("DROPBOX_APP_SECRET environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Dropbox app secret not configured. Please set DROPBOX_APP_SECRET environment variable." }], isError: true };
        }

        const redirectUri = process.env.DROPBOX_REDIRECT_URI;
        if (!redirectUri) {
          console.warn("Please set DROPBOX_REDIRECT_URI environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set DROPBOX_REDIRECT_URI environment variable. environment variable not configured. Please set Please set DROPBOX_REDIRECT_URI environment variable.."
            }],
            isError: true
          };
        }
        ...
        if (!refreshToken) {
          console.warn("Please set DROPBOX_REFRESH_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set DROPBOX_REFRESH_TOKEN environment variable. environment variable not configured. Please set Please set DROPBOX_REFRESH_TOKEN environment variable.."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ folderId, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!clientId) {
          console.warn("BOX_CLIENT_ID environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Box client ID not configured. Please set BOX_CLIENT_ID environment variable." }], isError: true };
        }

        const clientSecret = process.env.BOX_CLIENT_SECRET;
        if (!clientSecret) {
          console.warn("BOX_CLIENT_SECRET environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Box client secret not configured. Please set BOX_CLIENT_SECRET environment variable." }], isError: true };
        }

        const redirectUri = process.env.BOX_REDIRECT_URI;
        if (!redirectUri) {
          console.warn("BOX_REDIRECT_URI environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Box redirect URI not configured. Please set BOX_REDIRECT_URI environment variable." }], isError: true };
        }

        const refreshToken = process.env.BOX_REFRESH_TOKEN;
        if (!refreshToken) {
          console.warn("BOX_REFRESH_TOKEN environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Box refresh token not configured. Please set BOX_REFRESH_TOKEN environment variable." }], isError: true };
        }
    ...
    async ({
      ...
      try {
        ...
        if (!personalAccessToken) {
          console.warn("Please set GITHUB_PERSONAL_ACCESS_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set GITHUB_PERSONAL_ACCESS_TOKEN environment variable. environment variable not configured. Please set Please set GITHUB_PERSONAL_ACCESS_TOKEN environment variable.."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ databaseId, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        const token = process.env.NOTION_API_KEY;
        if (!token) {
          console.warn("NOTION_API_KEY environment variable not set, skipping operation."); return { content: [{ type: "text", text: "NOTION_API_KEY not configured. Please set NOTION_API_KEY environment variable." }], isError: true };
        }
  ...
  server.tool(
    ...
    async ({ teamId, channelId, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        const clientId = process.env.MICROSOFT_TEAMS_CLIENT_ID;
        if (!clientId) {
          console.warn("Please set MICROSOFT_TEAMS_CLIENT_ID environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set MICROSOFT_TEAMS_CLIENT_ID environment variable. environment variable not configured. Please set Please set MICROSOFT_TEAMS_CLIENT_ID environment variable.."
            }],
            isError: true
          };
        }
        ...
        const clientSecret = process.env.MICROSOFT_TEAMS_CLIENT_SECRET;
        if (!clientSecret) {
          console.warn("Please set MICROSOFT_TEAMS_CLIENT_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set MICROSOFT_TEAMS_CLIENT_SECRET environment variable. environment variable not configured. Please set Please set MICROSOFT_TEAMS_CLIENT_SECRET environment variable.."
            }],
            isError: true
          };
        }
        ...
        const refreshToken = process.env.MICROSOFT_TEAMS_REFRESH_TOKEN;
        if (!refreshToken) {
          console.warn("Please set MICROSOFT_TEAMS_REFRESH_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set MICROSOFT_TEAMS_REFRESH_TOKEN environment variable. environment variable not configured. Please set Please set MICROSOFT_TEAMS_REFRESH_TOKEN environment variable.."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ channelName, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        const botToken = process.env.SLACK_BOT_TOKEN;
        if (!botToken) {
          console.warn("SLACK_BOT_TOKEN environment variable not set, skipping operation."); return { content: [{ type: "text", text: "SLACK_BOT_TOKEN not configured. Please set SLACK_BOT_TOKEN environment variable." }], isError: true };
        }
  ...
  server.tool(
    ...
    async ({ channelName, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!botToken) {
          console.warn("DISCORD_BOT_TOKEN environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Discord bot token not configured. Please set DISCORD_BOT_TOKEN environment variable." }], isError: true };
        }
  ...
  server.tool(
    ...
    async ({ userName, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!token) {
          console.warn("TWITTER_TOKEN environment variable not set, skipping operation."); return { content: [{ type: "text", text: "Twitter token not configured. Please set TWITTER_TOKEN environment variable." }], isError: true };
        }
  ...
  server.tool(
    ...
    async ({ readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!clientId) {
          console.warn("Please set GOOGLE_EMAIL_CLIENT_ID environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set GOOGLE_EMAIL_CLIENT_ID environment variable. environment variable not configured. Please set Please set GOOGLE_EMAIL_CLIENT_ID environment variable.."
            }],
            isError: true
          };
        }
        ...
        if (!clientSecret) {
          console.warn("Please set GOOGLE_EMAIL_CLIENT_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set GOOGLE_EMAIL_CLIENT_SECRET environment variable. environment variable not configured. Please set Please set GOOGLE_EMAIL_CLIENT_SECRET environment variable.."
            }],
            isError: true
          };
        }
        ...
        if (!refreshToken) {
          console.warn("Please set GOOGLE_EMAIL_REFRESH_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set GOOGLE_EMAIL_REFRESH_TOKEN environment variable. environment variable not configured. Please set Please set GOOGLE_EMAIL_REFRESH_TOKEN environment variable.."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!clientId) {
          console.warn("Please set MICROSOFT_EMAIL_CLIENT_ID environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set MICROSOFT_EMAIL_CLIENT_ID environment variable. environment variable not configured. Please set Please set MICROSOFT_EMAIL_CLIENT_ID environment variable.."
            }],
            isError: true
          };
        }
        ...
        if (!clientSecret) {
          console.warn("Please set MICROSOFT_EMAIL_CLIENT_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set MICROSOFT_EMAIL_CLIENT_SECRET environment variable. environment variable not configured. Please set Please set MICROSOFT_EMAIL_CLIENT_SECRET environment variable.."
            }],
            isError: true
          };
        }
        ...
        if (!refreshToken) {
          console.warn("Please set MICROSOFT_EMAIL_REFRESH_TOKEN environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set MICROSOFT_EMAIL_REFRESH_TOKEN environment variable. environment variable not configured. Please set Please set MICROSOFT_EMAIL_REFRESH_TOKEN environment variable.."
            }],
            isError: true
          };
        }
  ...
  server.tool(
    ...
    async ({ projectName, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        const apiKey = process.env.LINEAR_API_KEY;
        if (!apiKey) {
          console.warn("LINEAR_API_KEY environment variable not set, skipping operation."); return { content: [{ type: "text", text: "LINEAR_API_KEY not configured. Please set LINEAR_API_KEY environment variable." }], isError: true };
        }
  ...
  server.tool(
    ...
    async ({ url, projectName, readLimit, recurring, repeatInterval }) => {
      ...
      try {
        ...
        if (!email) {
          console.warn("JIRA_EMAIL environment variable not set, skipping operation."); return { content: [{ type: "text", text: "JIRA_EMAIL not configured. Please set JIRA_EMAIL environment variable." }], isError: true };
        }

        const token = process.env.JIRA_TOKEN;
        if (!token) {
          console.warn("JIRA_TOKEN environment variable not set, skipping operation."); return { content: [{ type: "text", text: "JIRA_TOKEN not configured. Please set JIRA_TOKEN environment variable." }], isError: true };
        }
  ...
  server.tool(
    ...
    async ({ text }) => {
      ...
      if (!consumerKey) {
        console.warn("Please set TWITTER_CONSUMER_API_KEY environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set TWITTER_CONSUMER_API_KEY environment variable. environment variable not configured. Please set Please set TWITTER_CONSUMER_API_KEY environment variable.."
            }],
            isError: true
          };
      }
      ...
      if (!consumerSecret) {
        console.warn("Please set TWITTER_CONSUMER_API_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set TWITTER_CONSUMER_API_SECRET environment variable. environment variable not configured. Please set Please set TWITTER_CONSUMER_API_SECRET environment variable.."
            }],
            isError: true
          };
      }
      ...
      if (!accessTokenKey) {
        console.warn("Please set TWITTER_ACCESS_TOKEN_KEY environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set TWITTER_ACCESS_TOKEN_KEY environment variable. environment variable not configured. Please set Please set TWITTER_ACCESS_TOKEN_KEY environment variable.."
            }],
            isError: true
          };
      }
      ...
      if (!accessTokenSecret) {
        console.warn("Please set TWITTER_ACCESS_TOKEN_SECRET environment variable. environment variable not set, skipping operation.");
          return {
            content: [{
              type: "text",
              text: "Please set TWITTER_ACCESS_TOKEN_SECRET environment variable. environment variable not configured. Please set Please set TWITTER_ACCESS_TOKEN_SECRET environment variable.."
            }],
            isError: true
          };
      }
  ...
  server.tool(
    ...
    async ({ text, textType, subject, to }) => {
      ...
      if (!from) {
        console.warn("FROM_EMAIL_ADDRESS environment variable not set, skipping operation."); return { content: [{ type: "text", text: "FROM_EMAIL_ADDRESS not configured. Please set FROM_EMAIL_ADDRESS environment variable." }], isError: true };
      }
