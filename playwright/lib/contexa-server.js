...
import { ConsoleAdapter, ContexaTraceAdapter, MultiAdapter, TraceMiddleware, } from 'mcp-trace';
dotenv.config();
 ...
 */
export async function contexaStart(server) {
    const app = express();
    const transports = {};
    app.use(cors());
    ...
    app.get(['/health', '/'], (_req, res) => {
        res.json({ status: 'OK', server: SERVER_NAME, version: SERVER_VERSION, mcpServer: MCP_SERVER_NAME, mcpServerVersion: MCP_SERVER_VERSION });
    });
