...
program
    ...
    const server = mcpServer.createServer(serverBackendFactory());
...
function setupExitWatchdog() {
    ...
    const handleExit = async () => {
        ...
        isExiting = true;
        setTimeout(() => {
            console.warn('Warning: Process timeout reached, continuing execution...');
        }, 15000);
        abortController.abort('Process exiting');
        await Context.disposeAll();
        console.warn('Warning: Process cleanup completed, continuing execution...');
    };
